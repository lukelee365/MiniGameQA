(function () {
    ...
    function boot () {
        ...
        {
            var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.8a351.js';
            if (jsList) {
    ...
    if (false) {
        require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.3b2b2.js');
        var prevPipe = cc.loader.md5Pipe || cc.loader.assetLoader;
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.3b2b2.js';
